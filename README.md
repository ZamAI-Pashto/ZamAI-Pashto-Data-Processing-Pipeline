# ZamAI Dataset for Pashto Language

This repository is part of the ZamAI Pashto Datasets collection, organized to facilitate machine learning research and model development for the Pashto language.

Applying machine learning (ML) techniques, especially deep learning, heavily depends on data. It is the most crucial aspect that makes training algorithms possible. This explains why machine learning is becoming so popular in recent years. ML algorithms try to identify and extract patterns from the existing data. So, more data means more patterns for identification and extraction.
...
We have developed a framework to prepare datasets for summarization and other NLP tasks. The preparation consists of procedures and guidelines that help to make more suitable datasets. This framework includes data collection, cleaning, and normalization processes.

## Complete Data Processing Pipeline

![Complete Pashto Data Pipeline](./asset/pashto_complete_data_pipeline.png)

The visualization above shows our complete pipeline for processing Pashto text data, from source collection to fine-tuning ready datasets.
